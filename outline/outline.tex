...
\twocolumn[
	\begin{@twocolumnfalse}
		...
		\begin{tabular}{m{4.5cm} p{13.5cm} }
			               ...
			               & \noindent\LARGE{\textbf{A chemical explanation of graph neural networks $^\dag$}}                                             \\%Article title goes here instead of the text "This is the title"
...
\input{./content/attributions_analysis.tex}
