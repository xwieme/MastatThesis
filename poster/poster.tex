...
\begin{columns}
	...
	% 		\item \emph{Chemically explain} graph neural networks using substructure mask exploration and the \emph{Hamiache-Navarro value}.
	% 		\item \emph{Quantify} the correctness of the chemical intuitive \emph{explanation}.
	% 	\end{itemize}
	...
	\block[titleinnersep=0.3cm, bodyinnersep=0.5cm, linewidth=0.15cm]{Explain graph neural networks using the Shapley and Hamiache-Navarro value}{
		...
		\begin{tikzfigure}
			\includegraphics[scale=1]{../data/images/dimethyl_phthalate_difference.png}
			\hspace{2cm}
			\includegraphics[scale=1]{../data/images/dimethyl_phthalate_HN.png}
		\end{tikzfigure}
	}
...
\begin{columns}
	...
	\block{Quantify correctness of explanation}{
