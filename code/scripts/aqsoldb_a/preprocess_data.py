...
DATA_DIR = "../../../data/aqsoldb_A"


if __name__ == "__main__":
    aqsoldb = pd.read_csv(os.path.join(DATA_DIR, "aqsoldb_A_raw.csv"))[
    ...
    aqsoldb = aqsoldb.rename(columns={"SMILES": "smiles", "Solubility": "aqsoldb_A"})

    print(f"Filtered data set size: {len(aqsoldb)}\n")
    aqsoldb.to_csv(os.path.join(DATA_DIR, "aqsoldb_A.csv"))
    ...
    aqsoldb_train.to_csv(os.path.join(DATA_DIR, "aqsoldb_A_train.csv"))
    aqsoldb_validation.to_csv(os.path.join(DATA_DIR, "aqsoldb_A_val.csv"))
    aqsoldb_test.to_csv(os.path.join(DATA_DIR, "aqsoldb_A_test.csv"))
