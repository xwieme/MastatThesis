...
A popular optimization algorithm to optimize the weights of a neural network is 
...
which is nowadays the standard optimization algorithm in deep learning, is Adam.
